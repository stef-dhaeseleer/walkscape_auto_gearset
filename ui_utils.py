...
def _data_files_hash():
    """Compute a hash of all game data files for cache invalidation."""
    base_path = "game_data/wiki_export/autogenerated"
    files = ["equipment.json", "activities.json", "recipes.json", "locations.json",
             "services.json", "collectibles.json", "materials.json", "pets.json",
             "consumables.json", "containers.json"]
    h = hashlib.md5()
    for fname in files:
